...
export const INITIAL_ITINERARY: Activity[] = [
    { 
      ...
      keyDetails: 'Civitavecchia fue el puerto histórico de Roma desde el siglo II (fundado por Trajano como Centumcellae).', 
      priceEUR: 0, 
      type: 'logistics', 
      completed: false 
    },
    { 
      ...
      keyDetails: 'Consejo: Ten a mano tus documentos de identidad y tarjeta del crucero.', 
      priceEUR: 0, 
      type: 'transport', 
      completed: false 
    },
    ...
    { 
      ...
      description: 'Logística: El tren regional te lleva al corazón de la ciudad de Roma.', 
      keyDetails: '¡Crítico!: compra el ticket BIRG / No olvides poner tú nombre y fecha además de validar el ticket en las máquinas amarillas/verdes antes de subir al tren para evitar multas. Vista Escénica: Siéntate a la derecha para ver el mar Tirreno durante los primeros 20 minutos.', 
      priceEUR: 12, 
      type: 'transport', 
      completed: false, 
    ...
    { 
      ...
      keyDetails: 'La estación de metro está construida literalmente sobre cimientos romanos.', 
      priceEUR: 0, 
      type: 'transport', 
      completed: false, 
    ...
    { 
      ...
      type: 'sightseeing', 
      completed: false,
      audioGuideText: ARCO_CONSTANTINO_AUDIO_TEXT
    },
    { 
      id: '8', 
    ...
    { 
      ...
      type: 'sightseeing', 
      completed: false,
      audioGuideText: LOBA_CAPITULINA_AUDIO_TEXT
    },
    { 
      id: '11', 
    ...
    { 
      id: '13', 
      title: 'Monumento a Víctor Manuel II', 
      startTime: '11:50', 
      endTime: '12:00', 
    ...
    { 
      id: '21', 
      title: 'Tren de Regreso a Civitavecchia', 
      startTime: '15:02', 
      endTime: '16:02', 
    ...
    { 
      id: '22', 
      title: 'Bus Estación a Shuttle del Barco', 
      startTime: '16:10', 
      endTime: '16:20', 
      ...
      keyDetails: 'Compra en el kiosco de la Estación el ticket del bus', 
      priceEUR: 2, 
      type: 'transport', 
      completed: false,
